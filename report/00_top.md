...
| センサー異常検知評価 | 導入可否を精度・遅延・通知負荷で判断。[評価指標設計](2026-06-03_センサー異常検知の評価指標設計_レポート.md) | - | F1、AUC-PR、検知遅延、アラート件数で漏水・配管監視を評価。[評価指標設計](2026-06-03_センサー異常検知の評価指標設計_レポート.md) | - | NAB、TimeEval、ISO 8000-210、Evidentlyを評価軸に接続。[評価指標設計](2026-06-03_センサー異常検知の評価指標設計_レポート.md) |
...
| センサー設置・保護設計 | 露出部と保護部を分け、電源・通信・保守まで設計。[異常定義とセンサー実装設計](2026-04-30_異常定義とセンサー実装設計.md) | カメラ距離、角度、雨天、レンズ保護が性能に直結。[異常定義とセンサー実装設計](2026-04-30_異常定義とセンサー実装設計.md) | 音響/圧力/流量センサーの配置と保護が検知性能に直結。[異常定義とセンサー実装設計](2026-04-30_異常定義とセンサー実装設計.md) | 点群・画像取得機器の設置条件とメタデータ管理。[異常定義とセンサー実装設計](2026-04-30_異常定義とセンサー実装設計.md) | 屋外IoTのIP等級、日射、結露、通信、電源を整理。[異常定義とセンサー実装設計](2026-04-30_異常定義とセンサー実装設計.md) |
